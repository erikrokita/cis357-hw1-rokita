...
/** Main class where our program runs from */
public class CashRegister {
    public static void main(String args[]) throws IOException{
        ...
        do{
            System.out.println("Begin a new sale? (Y/N): ");
            ...
            if (input.toLowerCase().equals("y") || input.toLowerCase().equals("n")){
                ...
                System.out.println("Total with Tax (6%): " + saleRecord[saleNum].GetTotalWithTax());
                ...
                }while (Float.parseFloat(input) < saleRecord[saleNum].GetTotalWithTax());

                System.out.println("Change: " + (Float.parseFloat(input) - saleRecord[saleNum].GetTotalWithTax()));
                System.out.println("--------------------");
        ...
        System.out.println("Total sales made today: " + totalSales);
        System.out.println("Thank you for using this cash register system");

        scanner.close();
    }

    /** Function used to read the file of the supplied filename and places its contents into an array of Items */
    ...
    /** Function used to error-check each line of the file as we read each line */
    ...
    /**This function return a list that contains one copy of an item (via item code), along with its quantity and item total. used only at the end of a sale */
    ...
    /**Returns the name of the item given just the code */
    ...
    /**all this does is check if a value entered is of a valid type or not and handles exceptions accordingly */
